 ...
 *  @Contact: leeseechen@gmail.com, tvhang7@gmail.com
 */
/*  评论千万条 守规第一条 评论不规范 亲人两行泪
                                MMMMM
                                  MMMMMM
                                    MMMMMMM
                                     MMMMMMMM     .
...
public class Comment implements Serializable {
    ...
    private String commentUserId;   // 发布评论的用户 ID

    private String commentContent;  // 评论内容 暂时无法发表图片评论
    ...
    // 构造函数
    public Comment() {}
    public Comment(String commentUserId, String commentContent) {
